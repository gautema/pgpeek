            ...
            <.form for={%{}} phx-submit="save_llm" id="llm-form" class="max-w-lg space-y-4">
              <div>
                ...
                <input
                  ...
                  id="llm-model"
                  value={@llm_model}
                  class="w-full rounded-lg border border-white/10 bg-white/5 px-3.5 py-2.5 text-sm text-white placeholder-slate-500 focus:border-violet-500/50 focus:ring-1 focus:ring-violet-500/50 focus:outline-none transition-colors font-mono"
                  placeholder="anthropic:claude-sonnet-4-5-20250929"
                />
                <div class="mt-2 text-xs text-slate-500 space-y-1">
                  <p>
                    Format: <code class="text-slate-400">provider:model-id</code>. Leave empty to disable.
                  </p>
